...
public:
	...
	GUID get_command(t_uint32 p_index) {
		...
		static const GUID guid_toggle_output = { 0x9d87536e, 0xf82a, 0x4613,{ 0x8e, 0xd2, 0x82, 0xc, 0x6, 0x54, 0x6b, 0x63 } };
		...
		switch(p_index) {
			case cmd_toggle_output: return guid_toggle_output;
	...
	void get_name(t_uint32 p_index,pfc::string_base & p_out) {
		switch(p_index) {
			case cmd_toggle_output: p_out = "Toggle Output"; break;
	...
	bool get_description(t_uint32 p_index,pfc::string_base & p_out) {
		switch(p_index) {
			case cmd_toggle_output: p_out = "Turns WS2812 output on/off."; return true;
